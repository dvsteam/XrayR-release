...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/dvsteam/XrayR-release.git
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/dvsteam/XrayR-release.git"
